...
const threeOfKind = new SumDistro({
  count: 3,
  description: "Sum all dice if 3 are therae same",
});
const fourOfKind = new SumDistro({
  count: 4,
  description: "Sum all dice if 4 are therae same",
});
...
const yahtzee = new Yahtzee({ score: 5, description: "50 points for yahtzee" });
